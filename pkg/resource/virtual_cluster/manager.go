...
// +kubebuilder:rbac:groups=emrcontainers.services.k8s.aws,resources=virtualclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emrcontainers.services.k8s.aws,resources=virtualclusters/status,verbs=get;update;patch
...
type resourceManager struct {
	...
	sdkapi svcsdkapi.EMRContainersAPI
}
