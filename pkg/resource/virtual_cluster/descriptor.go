...
const (
	FinalizerString = "finalizers.emrcontainers.services.k8s.aws/VirtualCluster"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("virtualclusters")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.VirtualCluster{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VirtualCluster),
	}
}
