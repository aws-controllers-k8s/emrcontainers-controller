...
// +kubebuilder:rbac:groups=emrcontainers.services.k8s.aws,resources=jobruns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emrcontainers.services.k8s.aws,resources=jobruns/status,verbs=get;update;patch
