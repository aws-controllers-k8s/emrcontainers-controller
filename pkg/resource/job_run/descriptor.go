...
const (
	FinalizerString = "finalizers.emrcontainers.services.k8s.aws/JobRun"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("jobruns")
