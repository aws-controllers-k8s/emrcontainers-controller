...
const (
	FinalizerString = "finalizers.emrcontainers.services.k8s.aws/JobTemplate"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("jobtemplates")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.JobTemplate{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.JobTemplate),
	}
}
