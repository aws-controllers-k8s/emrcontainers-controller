...
// +kubebuilder:rbac:groups=emrcontainers.services.k8s.aws,resources=jobtemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emrcontainers.services.k8s.aws,resources=jobtemplates/status,verbs=get;update;patch
