...
func (in *JobRunSpec) DeepCopyInto(out *JobRunSpec) {
	*out = *in
	...
	if in.VirtualClusterRef != nil {
		in, out := &in.VirtualClusterRef, &out.VirtualClusterRef
...
func (in *JobTemplateData) DeepCopyInto(out *JobTemplateData) {
	*out = *in
	...
	if in.ParameterConfiguration != nil {
		...
		*out = make(map[string]*TemplateParameterConfiguration, len(*in))
		for key, val := range *in {
			var outVal *TemplateParameterConfiguration
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
func (in *JobTemplateSpec) DeepCopyInto(out *JobTemplateSpec) {
	*out = *in
	...
	if in.JobTemplateData != nil {
		in, out := &in.JobTemplateData, &out.JobTemplateData
		*out = new(JobTemplateData)
		(*in).DeepCopyInto(*out)
	}
	if in.KMSKeyARN != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobTemplate_SDK) DeepCopyInto(out *JobTemplate_SDK) {
	*out = *in
	if in.ARN != nil {
		in, out := &in.ARN, &out.ARN
		*out = new(string)
	...
	if in.DECRyptionError != nil {
		in, out := &in.DECRyptionError, &out.DECRyptionError
		*out = new(string)
		**out = **in
	}
	if in.ID != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobTemplate_SDK.
func (in *JobTemplate_SDK) DeepCopy() *JobTemplate_SDK {
	if in == nil {
		return nil
	}
	out := new(JobTemplate_SDK)
	in.DeepCopyInto(out)
	return out
}
